Ext.define('KJERP.view.shipping.List', {
	extend:'Ext.grid.Panel',
	requires:[
		'Ext.toolbar.Spacer',
		'KJERP.model.Shipping',
	...
	initComponent:function() {
		...
		me.columns = [
		{
			...
			text:'Estimated<br/>Departure',
			dataIndex:'shippingETD',
			renderer:_RENDER.dateYmd,
			width:100		    
		}, {
			text:'Estimated<br/>Arrival',
			dataIndex:'shippingETA',
			renderer:_RENDER.dateYmd,
			width:100		    
		}, {
			text:'Tag',
			...
			text:'Status',
			dataIndex:'state',
			renderer:_RENDER.stateShipping,
			width:100
		}, {
			text:'Remark',
			dataIndex:'remark',
		...
		me.callParent(arguments); //initShipping 부모의 실행한다. 		
