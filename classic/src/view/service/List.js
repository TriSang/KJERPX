Ext.define('KJERP.view.service.List', {
	...
	initComponent:function() {
		...
		me.columns = [
		{
			...
			renderer:_RENDER.serviceType			
		}, {
			text:'Service<br/>Category',
			dataIndex:'serviceCategory',
			renderer:_RENDER.serviceCategory						
		}, {
			...
			text:'Service<br/>Engineer',
			dataIndex:'workerContactName',			
			width:100				
		}, {
			text:'Service<br/>Company',
			dataIndex:'workerCompanySName',
			renderer:_RENDER.companySName,
			width:100			
		}, {
			text:'Location',
			...
			text:'Local Agent<br/>Contact',
			dataIndex:'localContactName',
			width:100				
		}, {
			text:'Local Agent<br/>Company',
			dataIndex:'localCompanySName',
			renderer:_RENDER.companySName,
			width:100				
		}, {
			text:'Service<br/>Company',
			dataIndex:'workerCompanyName',
			width:100		
		}, {
			text:'Service<br/>Company',
			dataIndex:'workerCompanyName',
			...
			text:'Service<br/>Order',
			dataIndex:'servicecOrder',
			width:100				
		}, {
			text:'Service<br/>Report',
			dataIndex:'serviceReport',
			width:100				
		}, {			
			text:'Started<br/>Date',
			dataIndex:'serviceSDate',
			renderer:_RENDER.dateYmd,
			width:100		    
		}, {
			text:'Finished<br/>Date',
			dataIndex:'serviceEDate',
			renderer:_RENDER.dateYmd,
			width:100	
		}, {
			text:'Requested<br/>Date',
			...
			text:'Payment<br/>Condition',
			dataIndex:'payment',
			width:100	
		}, {
			text:'Status',
			dataIndex:'state',
			renderer:_RENDER.stateService,
			width:100
		}, {
			text:'Report',
		...
		me.callParent(arguments); //initService 부모의 실행한다. 		
