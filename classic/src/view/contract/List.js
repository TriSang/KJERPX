Ext.define('KJERP.view.contract.List', {
	extend:'Ext.grid.Panel',
	requires:[
		'Ext.toolbar.Spacer',
		'KJERP.model.Contract',
	...
	dockedItems:[{
		...
		items:[{
				...
				xtype:'button', tooltip:_TOOLBAR.tooltip.contractToShipping, text:_TOOLBAR.label.contractToShipping, action:'transfer', glyph:_GLYPH.toolbar.transfer, disabled:false
			},{
	...
	initComponent:function() {
		...
		me.columns = [
		{
			...
			text:'Delivery<br/>Condition',
			dataIndex:'delivery',
			width:100				
		}, {
			text:'Status',
			dataIndex:'state',
			renderer:_RENDER.stateContract,
			width:100
		}, {
			text:'Remark',
			dataIndex:'remark',
		...
		me.callParent(arguments); //initContract 부모의 실행한다. 		
