Ext.define('KJERP.view.contract.Products', {
	extend: 'Ext.tree.Panel',
	requires:[
		'Ext.toolbar.Spacer',
		'KJERP.model.ContractItem',
	...
	initComponent:function() {
		...
		me.store = new Ext.data.TreeStore({
            model:'KJERP.model.ContractItem',
            remoteSort: false,
            autoLoad:false,
            autoDestroy:false,
        ...
        me.columns = [{
			...
			text:'Shipping<br/>Expect Date',
			dataIndex:'shippingDate',
			width:100,
			//value: new Date(),	// later change it for 1 month...
			renderer:_RENDER.dateYmdByToday,			
			align:'center',
			editor:{
				xtype:'datefield',				
				format: 'Y-m-d',
