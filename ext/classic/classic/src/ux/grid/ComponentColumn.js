 ...
 */
Ext.define('Ext.ux.grid.ComponentColumn', {
    extend: 'Ext.grid.column.Column',
    alias: 'widget.componentcolumn',
    requires: ['Ext.ux.grid.CTemplate'],
    ...
    calculateFrameWidth: function(component) {
        ...
        if (parentTd) {
        	...
        	return this.lastFrameWidth = parentDiv.getPadding('lr') + parentDiv.getBorderWidth('lr') + parentTd.getPadding('lr') + parentTd.getBorderWidth('lr'); 
//           return this.lastFrameWidth = parentDiv.getFrameWidth('lr') + parentTd.getFrameWidth('lr');
    ...
    createTemplate: function(tpl) {
        return tpl && tpl.isTemplate
            ? tpl
            : Ext.create('Ext.ux.grid.CTemplate', tpl || ['{', this.dataIndex ,'}']);
    },
